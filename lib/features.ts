...
export const facilitiesShowcase = [
  {
    title: "Swimming",
    caption: "Semi-Olympic swimming pool with trained instruction",
  ...
  },
  {
    ...
    caption: "Soundproof rooms, anti-skid flooring, antibacterial finishes",
    placeholder: "Smart classrooms",
  },
  {
    title: "Football",
    caption: "Football courts built to international standards",
    placeholder: "Football",
  },
  {
    title: "Basketball",
    caption: "Purpose-built basketball infrastructure",
    placeholder: "Basketball",
  },
  {
    title: "Lawn tennis",
    caption: "Lawn tennis courts as part of the sports campus",
    placeholder: "Lawn tennis",
  },
  {
    title: "Volleyball",
    caption: "Dedicated volleyball courts",
...
export const faqs = [
  ...
  },
  {
    ...
    a: "The school focuses on developing leaders of tomorrow. We believe in creating human beings, socially, emotionally and intellectually moulded to stand tall in society. They will carry strong principles of courage, strength, compassion, caring — and above all, learn to be happy.",
  },
  {
    q: "What are the school timings?",
    a: "Nursery & KG: 10:00 AM to 2:00 PM. Grade I upwards: 10:00 AM to 3:30 PM. Reporting time for all children is 9:45 AM.",
  },
  {
    q: "What extra-curricular activities does the school offer?",
    a: "Children are encouraged to participate in sport from their early days. Offerings include athletics (track and field), basketball, badminton, table tennis, lawn tennis, swimming, skating, splash pool, sand pit and an outdoor play area — alongside dance, drama, music, art, debate and cultural events.",
  },
  {
    q: "What curriculum does the school follow?",
    a: "For Nursery till KG: an integrated, thematic and activity-based approach. From Class I upward: textbooks and curriculum as per CBSE directives and guidelines.",
  },
  {
  ...
  },
  {
    ...
    a: "The campus uses surveillance and security systems, high boundary walls, a fire-fighting system, and well-trained male and female security guards. CCTV cameras are installed on each floor, in classrooms and corridors, and on all sides of the building.",
  },
  {
    q: "What is the student–teacher ratio?",
    a: "Nursery & KG: 24:1. Grade I to IV: 25:1. Grade V upwards: 30:1.",
  },
  {
    q: "What is the transport plan?",
    a: "Comfortable buses ply major routes in Kupwara. Each bus is fitted with GPS and CCTV. Each bus has a female attendant to take care of the children.",
  },
  {
    q: "What classes is the school up to?",
    a: "The school runs classes from Nursery to 12th. Admissions are currently open for Nursery to Class 6th — please confirm seat availability with the admissions office.",
  },
  {
    q: "What is the parent’s role?",
    a: "Parents are invited to be active members of the school management committee and to help shape a dynamic curriculum. Monthly parent–teacher sessions and mothers’ training are part of the school’s teaching mechanism.",
  },
];
